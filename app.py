...
def login():
    if request.method == 'POST':
        try:
            ...
            return "Login Failed. Database Error"
    return redirect(url_for('home'))
...
def ownprofile():
    if 'O_No' in session:
        ...
        try:
            ...
            return "Own Profile can't be load. Database Error."
    return redirect(url_for('home'))
...
def profile(id):
    ...
    if 'O_No' in session and ok == True:
        try:
            ...
            return "Database Error Or Parsing Error"
    else:
        return redirect(url_for('home'))
    ...
    if session['usertype'] != '4':
        ...
        if 'O_No' in session and ok == True:
            try:
                ...
                return "Database or Parsing Error."
